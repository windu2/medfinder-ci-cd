...
#Prueba de especialidad invalida con espacio al inicio
...
def test1():
    ...
    elem1 = driver.find_element(By.ID, "especialidad")
    elem1.send_keys(" Cardiologo")
...
#Prueba de especialidad con largo mayor a 50 caracteres
def test2():
    driver = webdriver.Chrome()
    driver.get(route + "/addMedico")
    ...
    elem1 = driver.find_element(By.ID, "especialidad")
    elem1.send_keys("CardiologoCardiologoCardiologoCardiologoCardiologoCardiologo")
    ...
    try:
        assert elem1.get_property("value") =="CardiologoCardiologoCardiologoCardiologoCardiologoCardiologo" 
        res = "Test2 fallo"
    except:
        res = "Test2 éxito"
...
#Prueba de especialida con símbolo especial
def test3():
    driver = webdriver.Chrome()
    driver.get(route + "/addMedico")
