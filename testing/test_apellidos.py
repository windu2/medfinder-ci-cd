...
#Apellido Paterno
#Prueba de apellido invalido con espacio al inicio
def test1():
    ...
    elem.send_keys("Oscar")
    
    elem1 = driver.find_element(By.ID, "apellido_P")
    elem1.send_keys(" Reyes")
...
#Prueba de apellido con largo mayor a 50 caracteres
def test2():
    driver = webdriver.Chrome()
    driver.get(route + "/addMedico")
    ...
    elem1 = driver.find_element(By.ID, "apellido_P")
    elem1.send_keys("CorreaCorreaCorreaCorreaCorreaCorreaCorreaCorreaCorrea")
    ...
    try:
        assert elem1.get_property("value") =="CorreaCorreaCorreaCorreaCorreaCorreaCorreaCorreaCorrea" 
        res = "Test2 fallo"
    except:
        res = "Test2 éxito"
...
#Prueba de apellido invalido con símbolo especial
def test3():
    driver = webdriver.Chrome()
    driver.get(route + "/addMedico")
...
def test4():
    ...
    elem1 = driver.find_element(By.ID, "apellido_M")
    elem1.send_keys(" Hevia")
...
def test5():
    ...
    elem1 = driver.find_element(By.ID, "apellido_M")
    elem1.send_keys("PerezPerezPerezPerezPerezPerezPerezPerezPerezPerezPerez")
    ...
    try:
        assert elem1.get_property("value") =="PerezPerezPerezPerezPerezPerezPerezPerezPerezPerezPerez" 
        res = "Test5 fallo"
    except:
        res = "Test5 éxito"
